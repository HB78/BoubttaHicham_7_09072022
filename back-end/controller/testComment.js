...
exports.getAllComment = async (req,res) => {
    try {
        ...
        let allcomment = `SELECT id, contenu, date_comment, users.name FROM commentaire INNER JOIN users
        ON commentaire.id_users = users.id;`;
        let [rows, fields] = await db.query(getAllComment);
